 ...
 * C source code generated on : Thu Jan 26 18:01:09 2017
 *
...
static void ctrl_sixaxis2thruster_output(void)
{
  ...
  /* '<S1>:1:3' */
  ctrl_sixaxis2thruster_B.omega = 0.0;

  /* '<S1>:1:4' */
  ctrl_sixaxis2thruster_B.alpha = 0.0;

  /*  [N] */
  /* [m] */
  /* '<S1>:1:11' */
  U_vsp = ctrl_sixaxis2thruster_B.PosYRight / 1.165;

  /* '<S1>:1:12' */
  U_bt = ctrl_sixaxis2thruster_B.PosXRight / 1.0187375;
  if (fabs(U_vsp) > 1.0) {
    /* '<S1>:1:14' */
    /* '<S1>:1:15' */
    if (U_vsp < 0.0) {
  ...
  ctrl_sixaxis2thruster_B.U_vsp = U_vsp;
  ctrl_sixaxis2thruster_B.U_bt = U_bt;
...
RT_MODEL_ctrl_sixaxis2thruste_T *ctrl_sixaxis2thruster(void)
{
  ...
  ctrl_sixaxis2thruster_M->Sizes.numBlocks = (13);/* Number of blocks */
  ctrl_sixaxis2thruster_M->Sizes.numBlockIO = (7);/* Number of block outputs */
  ctrl_sixaxis2thruster_M->Sizes.numBlockPrms = (61);/* Sum of parameter "widths" */
...
void SetExternalOutputs(double* data, int* TaskSampleHit)
{
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_sixaxis2thruster_B.U_vsp,
      0,0,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_sixaxis2thruster_B.alpha,
      0,0,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_sixaxis2thruster_B.U_bt,0,
      0,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_sixaxis2thruster_B.omega,
      0,0,0);
  } else {
    index += 1;
  }
...
int NI_InitExternalOutputs()
{
  ...
  // u_VSP1: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_sixaxis2thruster_B.U_vsp,0,
    0,0);

  // alpha_VSP2: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_sixaxis2thruster_B.alpha,0,
    0,0);
  ...
  // u_BT: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_sixaxis2thruster_B.U_bt,0,0,
    0);

  // omega_VSP1: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_sixaxis2thruster_B.omega,0,
    0,0);
...
{
  { 0, "ctrl_sixaxis2thruster/PosYRight", 0, "", offsetof
    (B_ctrl_sixaxis2thruster_T, PosYRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 1, "ctrl_sixaxis2thruster/PosXRight", 0, "", offsetof
    (B_ctrl_sixaxis2thruster_T, PosXRight)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1,
    2, 2, 0 },

  { 2, "ctrl_sixaxis2thruster/R2_continuous", 0, "", offsetof
    (B_ctrl_sixaxis2thruster_T, R2_continuous)+0*sizeof(real_T), BLOCKIO_SIG, 0,
    1, 2, 4, 0 },

  { 3, "ctrl_sixaxis2thruster/MATLAB Function", 0, "U_vsp", offsetof
    (B_ctrl_sixaxis2thruster_T, U_vsp)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 6,
    0 },

  { 4, "ctrl_sixaxis2thruster/MATLAB Function", 1, "U_bt", offsetof
    (B_ctrl_sixaxis2thruster_T, U_bt)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 8,
    0 },

  { 5, "ctrl_sixaxis2thruster/MATLAB Function", 2, "alpha", offsetof
    (B_ctrl_sixaxis2thruster_T, alpha)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    10, 0 },

  { 6, "ctrl_sixaxis2thruster/MATLAB Function", 3, "omega", offsetof
    (B_ctrl_sixaxis2thruster_T, omega)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    12, 0 },

  { -1, "", -1, "", 0, 0, 0 }
};

static int NI_SigListSize DataSection(".NIVS.siglistsize") = 7;
...
{
  { 0, "PosYRight", 0, EXT_IN, 1, 1, 1 },

  { 1, "PosXRight", 0, EXT_IN, 1, 1, 1 },

  { 2, "R2_continuous", 0, EXT_IN, 1, 1, 1 },
...
static char* NI_CompiledModelVersion = "1.33";
static char* NI_CompiledModelDateTime = "Thu Jan 26 18:01:09 2017";
