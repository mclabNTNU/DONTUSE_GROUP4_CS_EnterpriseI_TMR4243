...
typedef struct {
  ...
  real_T U_vsp;                        /* '<Root>/MATLAB Function' */
  real_T U_bt;                         /* '<Root>/MATLAB Function' */
  real_T alpha;                        /* '<Root>/MATLAB Function' */
  real_T omega;                        /* '<Root>/MATLAB Function' */
 ...
 * '<S2>'   : 'ctrl_sixaxis2thruster/Subsystem'
 */
